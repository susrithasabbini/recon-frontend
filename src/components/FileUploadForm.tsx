...
const FileUploadForm: React.FC<FileUploadFormProps> = ({
  ...
  return (
    <motion.div variants={scaleIn} initial="hidden" animate="visible" className="mt-6">
      <Card className="shadow-xl border border-gray-100 dark:border-gray-800 bg-gradient-to-br from-white via-gray-50 to-gray-100 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 w-full">
        ...
        <CardBody className="p-4 sm:p-6">
          ...
          >
            <div className="flex flex-col gap-2">
              <label htmlFor="transaction-upload-input" className="font-medium">Transaction File</label>
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="processing-mode-select" className="font-medium">Processing Mode</label>
              <Select
            ...
            <Button
              ...
              className="w-full"
              isLoading={loading}
              isDisabled={loading || !isFileSelected || !selectedAccount || !processingMode}
        ...
        {filename && uploadStatus && ( // Show footer only if a file was chosen and there's an upload status
